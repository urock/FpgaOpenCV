...
--Date        : Mon Feb 08 16:58:29 2016
--Host        : xserverPC running 64-bit major release  (build 7600)
--Command     : generate_target embv_python1300c_fb_wrapper.bd
--Design      : embv_python1300c_fb_wrapper
...
entity embv_python1300c_fb_wrapper is
  port (
...
end embv_python1300c_fb_wrapper;

architecture STRUCTURE of embv_python1300c_fb_wrapper is
  component embv_python1300c_fb is
  port (
    DDR_cas_n : inout STD_LOGIC;
    DDR_cke : inout STD_LOGIC;
    DDR_ck_n : inout STD_LOGIC;
  ...
  end component embv_python1300c_fb;
begin
embv_python1300c_fb_i: component embv_python1300c_fb
     port map (
