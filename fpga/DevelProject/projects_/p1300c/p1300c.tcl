...
source ./[string tolower $board].tcl -notrace
puts "OKI DOKI"
avnet_create_project $project $projects_folder $scriptdir
#
remove_files -fileset constrs_1 *.xdc
add_files -fileset constrs_1 -norecurse ../../src_/xdc/embv_python1300.xdc

# Add Avnet IP Repository
puts "***** Updating Vivado to include IP Folder"
set_property ip_repo_paths  ../../src_/ip [current_fileset]
update_ip_catalog
